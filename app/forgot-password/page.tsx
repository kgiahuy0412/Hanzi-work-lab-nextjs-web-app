...
export default async function ForgotPasswordPage({ searchParams }: { searchParams: Promise<{ sent?: string }> }) {
  ...
  return <main className="auth-page"><section className="auth-card">
    ...
    <div className="auth-heading"><span>Bảo mật tài khoản</span><h1>Đặt lại mật khẩu</h1><p>Nhập email đã đăng ký. Nếu tài khoản tồn tại, Himi Chinese sẽ gửi một liên kết dùng một lần.</p></div>

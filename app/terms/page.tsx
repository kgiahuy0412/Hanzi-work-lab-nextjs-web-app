...
export const metadata: Metadata = {
  ...
  description: "Điều khoản sử dụng dịch vụ học tiếng Trung HanziWork.",
};
...
export default function TermsPage() {
  return <main className="legal-page"><article className="legal-card">
    ...
    <p className="legal-lead">Các điều khoản dưới đây giúp bạn hiểu phạm vi của bản beta và cách sử dụng nội dung học tập trên HanziWork.</p>
    ...
    <section><h2>3. Trạng thái beta</h2><p>HanziWork đang trong giai đoạn beta. Nội dung, tiến độ và một số tính năng có thể được điều chỉnh để cải thiện chất lượng. Thanh toán chưa được mở ở thời điểm cập nhật này.</p></section>

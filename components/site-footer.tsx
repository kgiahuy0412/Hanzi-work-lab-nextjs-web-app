...
export function SiteFooter() {
  return <footer className="site-footer"><div className="section-shell">
    <div className="footer-grid">
      ...
      <nav className="footer-column" aria-label="Sản phẩm"><strong>Sản phẩm</strong><Link href="/admin">Admin mẫu</Link><Link href="/vip#chinh-sach">Chính sách VIP</Link><Link href="/courses">Nội dung miễn phí</Link></nav>
